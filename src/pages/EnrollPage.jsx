...
export default function EnrollPage() {
  ...
  return (
    <div className="bg-[#f8fafc] font-outfit min-h-screen pb-16 animate-page-fade">
      ...
      <section className="relative bg-white overflow-hidden pt-4 md:pt-6 pb-8 lg:pb-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-6 space-y-4 text-center lg:text-left flex flex-col justify-between h-full">
              <div className="space-y-3">
                ...
                <h1 className="font-fredoka text-3xl md:text-[36px] font-extrabold text-brand-blue leading-tight tracking-tight">
                ...
                <p className="text-black text-sm max-w-md mx-auto lg:mx-0 font-normal leading-relaxed">
              ...
              <div className="mt-4 flex justify-center lg:justify-start">
                <img 
                  ...
                  className="w-full max-w-md md:max-w-lg h-auto max-h-[220px] lg:max-h-[280px] object-contain pointer-events-none select-none"
                />
              </div>
            </div>
            ...
            <div className="lg:col-span-6">
              <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-xl border border-slate-100/80">
                
                {/* Form Title */}
                <div className="text-center mb-4">
                  <h3 className="font-fredoka text-lg font-bold text-brand-blue uppercase tracking-wide">
                ...
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3.5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-white border border-slate-200 focus:border-brand-blue focus:ring-1 focus:ring-brand-blue rounded-xl py-2.5 pl-11 pr-4 text-sm md:text-base text-slate-800 placeholder-slate-400 focus:outline-none transition-colors"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                      ...
                      <div className="relative">
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className="w-full bg-white border border-slate-200 focus:border-brand-blue focus:ring-1 focus:ring-brand-blue rounded-xl py-2.5 pl-11 pr-10 text-sm md:text-base text-slate-800 placeholder-slate-400 focus:outline-none transition-colors appearance-none cursor-pointer"
                        >
                          <option value="" disabled>Select Program</option>
                          <option value="daycare">Day Care (1.5-5 Yrs)</option>
                          <option value="playgroup">Play Group (1.5-3 Yrs)</option>
                          <option value="nursery">Nursery (3+ Yrs)</option>
                          <option value="junior-kg">Junior KG (4+ Yrs)</option>
                          <option value="senior-kg">Senior KG (5+ Yrs)</option>
                        </select>
                    ...
                    {/* Additional Notes */}
                    <div className="relative">
                      <div className="absolute top-3 flex items-start pointer-events-none text-brand-blue">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        className="w-full bg-white border border-slate-200 focus:border-brand-blue focus:ring-1 focus:ring-brand-blue rounded-xl py-2.5 pl-11 pr-4 text-sm md:text-base text-slate-800 placeholder-slate-400 focus:outline-none transition-colors resize-none"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      className="w-full bg-brand-yellow hover:bg-brand-orange text-brand-blue hover:text-white font-fredoka font-bold py-3 px-6 rounded-xl flex justify-between items-center transition-all duration-300 shadow-md hover:shadow-lg focus:outline-none text-sm md:text-base"
                    >
